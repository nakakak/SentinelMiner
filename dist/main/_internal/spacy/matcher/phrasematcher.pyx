...
cdef class PhraseMatcher:
    ...
    USAGE: https://spacy.io/usage/rule-based-matchingphrasematcher
    ...
    def __init__(self, Vocab vocab, attr="ORTH", validate=False):
        ...
        DOCS: https://spacy.io/api/phrasematcherinit
        """
        self.vocab = vocab
        self._callbacks = {}
        self._docs = {}
    ...
    def __len__(self):
        ...
        DOCS: https://spacy.io/api/phrasematcherlen
        """
    ...
    def __contains__(self, key):
        ...
        DOCS: https://spacy.io/api/phrasematchercontains
        """
    ...
    def remove(self, key):
        ...
        DOCS: https://spacy.io/api/phrasematcherremove
        """
    ...
    def add(self, key, docs, *_docs, on_match=None):
        ...
        *_docs (Doc): For backwards compatibility: list of patterns to add
        ...
        DOCS: https://spacy.io/api/phrasematcheradd
        """
    ...
    def __call__(self, object doclike, *, as_spans=False):
        ...
        DOCS: https://spacy.io/api/phrasematchercall
        """
        matches = []
