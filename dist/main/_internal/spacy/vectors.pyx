...
cdef class Vectors:
    ...
    def __init__(self, *, strings=None, shape=None, data=None, keys=None, name=None, mode=Mode.default, minn=0, maxn=0, hash_count=1, hash_seed=0, bow="<", eow=">"):
        ...
        DOCS: https://spacy.io/api/vectorsinit
        """
    ...
    def shape(self):
        ...
        DOCS: https://spacy.io/api/vectorsshape
        """
    ...
    def size(self):
        ...
        DOCS: https://spacy.io/api/vectorssize
        """
    ...
    def is_full(self):
        ...
        DOCS: https://spacy.io/api/vectorsis_full
        """
    ...
    def n_keys(self):
        ...
        DOCS: https://spacy.io/api/vectorsn_keys
        """
        if self.mode == Mode.floret:
            return -1
    ...
    def __getitem__(self, key):
        ...
        DOCS: https://spacy.io/api/vectorsgetitem
        """
        if self.mode == Mode.default:
    ...
    def __setitem__(self, key, vector):
        ...
        DOCS: https://spacy.io/api/vectorssetitem
        """
        if self.mode == Mode.floret:
    ...
    def __iter__(self):
        ...
        DOCS: https://spacy.io/api/vectorsiter
        """
    ...
    def __len__(self):
        ...
        DOCS: https://spacy.io/api/vectorslen
        """
    ...
    def __contains__(self, key):
        ...
        DOCS: https://spacy.io/api/vectorscontains
        """
        if self.mode == Mode.floret:
            return True
        else:
    ...
    def resize(self, shape, inplace=False):
        ...
        DOCS: https://spacy.io/api/vectorsresize
        """
        if self.mode == Mode.floret:
    ...
    def values(self):
        ...
        DOCS: https://spacy.io/api/vectorsvalues
        """
    ...
    def items(self):
        ...
        DOCS: https://spacy.io/api/vectorsitems
        """
    ...
    def add(self, key, *, vector=None, row=None):
        ...
        DOCS: https://spacy.io/api/vectorsadd
        """
        if self.mode == Mode.floret:
    ...
    def to_disk(self, path, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/vectorsto_disk
        """
        xp = get_array_module(self.data)
        if xp is numpy:
    ...
    def from_disk(self, path, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/vectorsfrom_disk
        """
    ...
    def to_bytes(self, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/vectorsto_bytes
        """
    ...
    def from_bytes(self, data, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/vectorsfrom_bytes
        """
    ...
    def clear(self):
        ...
        DOCS: https://spacy.io/api/vectorsclear
        """
        if self.mode == Mode.floret:
