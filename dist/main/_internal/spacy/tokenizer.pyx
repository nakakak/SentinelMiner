...
cdef class Tokenizer:
    ...
    def __init__(self, Vocab vocab, rules=None, prefix_search=None,
        ...
        DOCS: https://spacy.io/api/tokenizerinit
        """
        self.mem = Pool()
    ...
    def __call__(self, str string):
        ...
        DOCS: https://spacy.io/api/tokenizercall
        """
    ...
    def pipe(self, texts, batch_size=1000):
        ...
        DOCS: https://spacy.io/api/tokenizerpipe
        """
        for text in texts:
            yield self(text)
    ...
    def find_infix(self, str string):
        ...
        DOCS: https://spacy.io/api/tokenizerfind_infix
        """
    ...
    def find_prefix(self, str string):
        ...
        DOCS: https://spacy.io/api/tokenizerfind_prefix
        """
    ...
    def find_suffix(self, str string):
        ...
        DOCS: https://spacy.io/api/tokenizerfind_suffix
        """
    ...
    def add_special_case(self, str string, substrings):
        ...
        DOCS: https://spacy.io/api/tokenizeradd_special_case
        """
    ...
    def explain(self, text):
        ...
        DOCS: https://spacy.io/api/tokenizerexplain
        """
    ...
    def to_disk(self, path, **kwargs):
        ...
        DOCS: https://spacy.io/api/tokenizerto_disk
        """
    ...
    def from_disk(self, path, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/tokenizerfrom_disk
        """
        path = util.ensure_path(path)
    ...
    def to_bytes(self, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/tokenizerto_bytes
        """
        serializers = {
    ...
    def from_bytes(self, bytes_data, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/tokenizerfrom_bytes
        """
        data = {}
        deserializers = {
