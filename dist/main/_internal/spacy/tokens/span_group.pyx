...
cdef class SpanGroup:
    ...
    def __init__(self, doc, *, name="", attrs={}, spans=[]):
        ...
        DOCS: https://spacy.io/api/spangroupinit
        """
    ...
    def doc(self):
        ...
        DOCS: https://spacy.io/api/spangroupdoc
        """
        doc = self._doc_ref()
        if doc is None:
    ...
    def has_overlap(self):
        ...
        DOCS: https://spacy.io/api/spangrouphas_overlap
        """
        if not len(self):
            return False
    ...
    def __len__(self):
        ...
        DOCS: https://spacy.io/api/spangrouplen
        """
        return self.c.size()
    ...
    def __getitem__(self, int i) -> Span:
        ...
        DOCS: https://spacy.io/api/spangroupgetitem
        """
    ...
    def __delitem__(self, int i):
        ...
        DOCS: https://spacy.io/api/spangroupdelitem
        """
        i = self._normalize_index(i)
    ...
    def __setitem__(self, int i, Span span):
        ...
        DOCS: https://spacy.io/api/spangroupsetitem
        """
    ...
    def __iadd__(self, other: Union[SpanGroup, Iterable["Span"]]) -> SpanGroup:
        ...
        DOCS: https://spacy.io/api/spangroupiadd
        """
    ...
    def __add__(self, other: SpanGroup) -> SpanGroup:
        ...
        DOCS: https://spacy.io/api/spangroupadd
        """
    ...
    def append(self, Span span):
        ...
        DOCS: https://spacy.io/api/spangroupappend
        """
        if span.doc is not self.doc:
            raise ValueError(Errors.E855.format(obj="span"))
        self.push_back(span.c)
    ...
    def extend(self, spans_or_span_group: Union[SpanGroup, Iterable["Span"]]):
        ...
        DOCS: https://spacy.io/api/spangroupextend
        """
    ...
    def to_bytes(self):
        ...
        DOCS: https://spacy.io/api/spangroupto_bytes
        """
    ...
    def from_bytes(self, bytes_data):
        ...
        DOCS: https://spacy.io/api/spangroupfrom_bytes
        """
    ...
    def copy(self)  -> SpanGroup:
        ...
        DOCS: https://spacy.io/api/spangroupcopy
        """
        return SpanGroup(
            self.doc,
            name=self.name,
