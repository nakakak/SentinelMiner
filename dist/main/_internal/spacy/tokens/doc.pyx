...
cdef class Doc:
    ...
    def set_extension(cls, name, **kwargs):
        ...
        DOCS: https://spacy.io/api/docset_extension
        USAGE: https://spacy.io/usage/processing-pipelinescustom-components-attributes
        """
    ...
    def get_extension(cls, name):
        ...
        DOCS: https://spacy.io/api/docget_extension
        """
    ...
    def has_extension(cls, name):
        ...
        DOCS: https://spacy.io/api/dochas_extension
        """
    ...
    def remove_extension(cls, name):
        ...
        DOCS: https://spacy.io/api/docremove_extension
        """
    ...
    def __init__(
        ...
        *,
        ...
        DOCS: https://spacy.io/api/docinit
        """
        self.vocab = vocab
    ...
    def has_annotation(self, attr, *, require_complete=False):
        ...
        DOCS: https://spacy.io/api/dochas_annotation
        """
    ...
    def __getitem__(self, object i):
        ...
        DOCS: https://spacy.io/api/docgetitem
        """
    ...
    def __iter__(self):
        ...
        DOCS: https://spacy.io/api/dociter
        """
        cdef int i
    ...
    def __len__(self):
        ...
        DOCS: https://spacy.io/api/doclen
        """
        return self.length
    ...
    def char_span(self, int start_idx, int end_idx, label=0, kb_id=0, vector=None, alignment_mode="strict", span_id=0):
        ...
        DOCS: https://spacy.io/api/docchar_span
        """
    ...
    def similarity(self, other):
        ...
        DOCS: https://spacy.io/api/docsimilarity
        """
    ...
    def has_vector(self):
        ...
        DOCS: https://spacy.io/api/dochas_vector
        """
    ...
    property vector:
        ...
        DOCS: https://spacy.io/api/docvector
        """
        def __get__(self):
    ...
    property vector_norm:
        ...
        DOCS: https://spacy.io/api/docvector_norm
        """
        def __get__(self):
    ...
    property ents:
        ...
        DOCS: https://spacy.io/api/docents
        """
        def __get__(self):
            cdef int i
    ...
    def noun_chunks(self):
        ...
        DOCS: https://spacy.io/api/docnoun_chunks
        """
    ...
    def sents(self):
        ...
        DOCS: https://spacy.io/api/docsents
        """
    ...
    def count_by(self, attr_id_t attr_id, exclude=None, object counts=None):
        ...
        DOCS: https://spacy.io/api/doccount_by
        """
        cdef int i
        cdef attr_t attr
        cdef size_t count
    ...
    def from_array(self, attrs, array):
        ...
        DOCS: https://spacy.io/api/docfrom_array
        """
         Handle scalar/list inputs of strings/ints for py_attr_ids
         See also 3064
    ...
    def from_docs(docs, ensure_whitespace=True, attrs=None, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/docfrom_docs
        """
        if not docs:
            return None
    ...
    def get_lca_matrix(self):
        ...
        DOCS: https://spacy.io/api/docget_lca_matrix
        """
    ...
    def to_disk(self, path, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/docto_disk
        """
    ...
    def from_disk(self, path, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/docfrom_disk
        """
        path = util.ensure_path(path)
    ...
    def to_bytes(self, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/docto_bytes
        """
    ...
    def from_bytes(self, bytes_data, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/docfrom_bytes
        """
    ...
    def from_dict(self, msg, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/docfrom_dict
        """
        if self.length != 0:
    ...
    def retokenize(self):
        ...
        DOCS: https://spacy.io/api/docretokenize
        USAGE: https://spacy.io/usage/linguistic-featuresretokenization
        """
