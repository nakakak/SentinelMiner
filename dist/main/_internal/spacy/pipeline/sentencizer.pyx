...
class Sentencizer(Pipe):
    ...
    def __init__(
        ...
        *,
        ...
        DOCS: https://spacy.io/api/sentencizerinit
        """
        self.name = name
        if punct_chars:
    ...
    def __call__(self, doc):
        ...
        DOCS: https://spacy.io/api/sentencizercall
        """
    ...
    def to_bytes(self, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/sentencizerto_bytes
        """
    ...
    def from_bytes(self, bytes_data, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/sentencizerfrom_bytes
        """
    ...
    def to_disk(self, path, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/sentencizerto_disk
        """
    ...
    def from_disk(self, path, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/sentencizerfrom_disk
        """
        path = util.ensure_path(path)
        path = path.with_suffix(".json")
