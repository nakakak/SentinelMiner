...
cdef class TrainablePipe(Pipe):
    ...
    def __init__(self, vocab: Vocab, model: Model, name: str, **cfg):
        ...
        **cfg: Additional settings and config parameters.
        ...
        DOCS: https://spacy.io/api/pipeinit
        """
        self.vocab = vocab
        self.model = model
        self.name = name
    ...
    def __call__(self, Doc doc) -> Doc:
        ...
        DOCS: https://spacy.io/api/pipecall
        """
    ...
    def pipe(self, stream: Iterable[Doc], *, batch_size: int=128) -> Iterator[Doc]:
        ...
        DOCS: https://spacy.io/api/pipepipe
        """
        error_handler = self.get_error_handler()
    ...
    def predict(self, docs: Iterable[Doc]):
        ...
        DOCS: https://spacy.io/api/pipepredict
        """
    ...
    def set_annotations(self, docs: Iterable[Doc], scores):
        ...
        DOCS: https://spacy.io/api/pipeset_annotations
        """
    ...
    def update(self,
        ...
        DOCS: https://spacy.io/api/pipeupdate
        """
        if losses is None:
            losses = {}
    ...
    def rehearse(self,
        ...
        DOCS: https://spacy.io/api/piperehearse
        """
        pass
    ...
    def get_loss(self, examples: Iterable[Example], scores) -> Tuple[float, float]:
        ...
        DOCS: https://spacy.io/api/pipeget_loss
        """
    ...
    def create_optimizer(self) -> Optimizer:
        ...
        DOCS: https://spacy.io/api/pipecreate_optimizer
        """
    ...
    def initialize(self, get_examples: Callable[[], Iterable[Example]], *, nlp: Language=None):
        ...
        DOCS: https://spacy.io/api/pipeinitialize
        """
    ...
    def add_label(self, label: str) -> int:
        ...
        DOCS: https://spacy.io/api/pipeadd_label
        """
    ...
    def use_params(self, params: dict):
        ...
        DOCS: https://spacy.io/api/pipeuse_params
        """
    ...
    def finish_update(self, sgd: Optimizer) -> None:
        ...
        DOCS: https://spacy.io/api/pipefinish_update
        """
    ...
    def to_bytes(self, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/pipeto_bytes
        """
    ...
    def from_bytes(self, bytes_data, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/pipefrom_bytes
        """
        self._validate_serialization_attrs()
    ...
    def to_disk(self, path, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/pipeto_disk
        """
        self._validate_serialization_attrs()
        serialize = {}
        if hasattr(self, "cfg") and self.cfg is not None:
    ...
    def from_disk(self, path, *, exclude=tuple()):
        ...
        DOCS: https://spacy.io/api/pipefrom_disk
        """
        self._validate_serialization_attrs()
