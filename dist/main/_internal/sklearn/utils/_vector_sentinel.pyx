...
cdef class StdVectorSentinelFloat64(StdVectorSentinel):
    ...
    cdef StdVectorSentinel create_for(vector[float64_t] * vect_ptr):
         ...
         See: https://cython.readthedocs.io/en/latest/src/userguide/extension_types.htmlinstantiation-from-existing-c-c-pointers  noqa
...
cdef cnp.ndarray vector_to_nd_array(vector_typed * vect_ptr):
    cdef:
     ...
     See: https://docs.python.org/3/c-api/intro.htmlreference-count-details
    Py_INCREF(sentinel)
