...
class Connection(object):
    ...
    def rollback(self, *args: Any, **kwargs: Any) -> None: ...
     ...
     see https://docs.python.org/2/library/sqlite3.htmlsqlite3.Connection.set_authorizer
     returns [SQLITE_OK, SQLITE_DENY, SQLITE_IGNORE] so perhaps int
    def set_authorizer(self, *args: Any, **kwargs: Any) -> None: ...
     set_progress_handler(handler, n) -> see https://docs.python.org/2/library/sqlite3.htmlsqlite3.Connection.set_progress_handler
    ...
    def set_trace_callback(self, *args: Any, **kwargs: Any) -> None: ...
     ...
     without sqlite3 loadable extension support. see footnotes https://docs.python.org/3/library/sqlite3.htmlf1
