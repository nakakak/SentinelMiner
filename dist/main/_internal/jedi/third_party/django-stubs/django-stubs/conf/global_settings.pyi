...
FILE_UPLOAD_TEMP_DIR: Optional[str] = ...
 ...
 you'd pass directly to os.chmod; see https://docs.python.org/library/os.htmlfiles-and-directories.
FILE_UPLOAD_PERMISSIONS = None

 The numeric mode to assign to newly-created directories, when uploading files.
 The value should be a mode as you'd pass to os.chmod;
 see https://docs.python.org/library/os.htmlfiles-and-directories.
...
SHORT_DATETIME_FORMAT: str = ...
 ...
 https://docs.python.org/library/datetime.htmlstrftime-behavior
